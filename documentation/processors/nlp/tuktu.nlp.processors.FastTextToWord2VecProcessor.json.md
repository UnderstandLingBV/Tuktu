### tuktu.nlp.processors.FastTextToWord2VecProcessor
Loads pre-trained fastText model and transfers the word vectors word-by-word to a target word2vec model.
  ...
  * **config** *(type: object)* `[Required]`
    ...
    * **model_name** *(type: string)* `[Required]`
    - Name of the target word2vec model that will be transferred to.

    * **file_name** *(type: string)* `[Required]`
    - The file name to deserialize the fastText model from.
