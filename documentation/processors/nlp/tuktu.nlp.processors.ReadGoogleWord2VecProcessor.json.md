### tuktu.nlp.processors.ReadGoogleWord2VecProcessor
Word2Vec trained by Google's word2vec can be read by this processor.
  ...
  * **config** *(type: object)* `[Required]`
    ...
    * **binary** *(type: boolean)* `[Optional, default = false]`
    - If set to true, load a binary word2vec file.
